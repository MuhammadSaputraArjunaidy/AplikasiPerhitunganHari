...
- Dropdown menu yang memungkinkan pengguna memilih bulan yang ingin dihitung atau dilihat. Bulan yang dipilih akan mempengaruhi tampilan kalender.

2. Masukkan Tahun:

- Kolom input untuk memasukkan tahun. Setelah tahun dimasukkan, aplikasi akan menampilkan kalender untuk bulan dan tahun yang dipilih.

3. Tombol :

- Hitung: Tombol yang digunakan untuk memproses pilihan bulan dan tahun, serta menampilkan kalender yang sesuai dengan pilihan pengguna.
